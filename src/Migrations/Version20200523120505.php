 ...
 */
final class Version20200523120505 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD status INT DEFAULT NULL, CHANGE driver_id driver_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP status, CHANGE driver_id driver_id INT NOT NULL');
    }
}
