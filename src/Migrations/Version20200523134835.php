 ...
 */
final class Version20200523134835 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD driver_id INT DEFAULT NULL, ADD admin_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP driver_id, DROP admin_id');
    }
}
